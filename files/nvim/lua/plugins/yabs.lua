...
-- vim.api.nvim_set_keymap("n", "<leader>r", "<Plug>yabs_run_default", {})
-- vim.api.nvim_set_keymap("n", "<leader>r", "<Plug>YabsDefaultTask", {})

--vim.api.nvim_set_keymap('n', '<leader>r', ':YabsDefaultTask<CR>', { noremap = true, silent = false })
vim.api.nvim_set_keymap('n', '<leader>r', ':w<CR>:YabsDefaultTask<CR>', { noremap = true, silent = false })
